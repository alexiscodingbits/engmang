...
export function DotPattern({
  ...
  gap = 24,
  baseColor = '#404040',
  glowColor = '#10b981', // emerald-500 — matches site accent colour
  proximity = 120,
  glowIntensity = 1,
  waveSpeed = 0.5,
}: DotPatternProps) {
  ...
  useEffect(() => {
    ...
    // Use window so events fire even when the cursor is over content
    // that sits above the fixed -z-10 canvas layer.
